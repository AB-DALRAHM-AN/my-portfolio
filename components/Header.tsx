...
const Header = () => {
  return (
    <div className="container sticky top-5 z-50 w-full rounded-3xl border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
