...
The most annoying thing about lists in Markdown is that `<li>` elements aren't given a child `<span>` tag unless there are multiple paragraphs in the list item. That means I have to worry about styling that annoying situation too.

- **For example, here's another nested list.**

  But this time with a second paragraph.

  - These list items won't have `<span>` tags
...
- **But in this second top-level list item, they will.**
  ...
  - As you can see here, because I've added a second line, this list item now has a `<span>` tag.
